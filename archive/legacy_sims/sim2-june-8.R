Here is the complete pipeline enclosed within a single, continuous markdown code block. You can click the copy icon at the top right of this block to copy the entire script at once.
